...
In this example:
    - EXTI2_11 is connected to PC11 pin
      - when falling edge is detected on EXTI2_11 by pressing USER2 push-button, LED1 toggles once
      - LED1 is ON in case of error in initialization

On STM32MP257F-PHYFLEX:
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32MP257F-PHYFLEX board and can be
