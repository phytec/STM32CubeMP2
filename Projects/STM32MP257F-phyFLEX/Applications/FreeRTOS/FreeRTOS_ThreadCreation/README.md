...
In the first 5 seconds, the thread 1 toggles LED1 each 200 ms and the thread 2 toggles LED1 each 500 ms.
In the following 5 seconds, the thread 1 suspends itself and the thread 2 continue toggling LED1.
...
LED1 turns ON if any error occurs.
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_ThreadCreation/Inc/stm32mp257f_phyflex_conf.h             BSP configuration file

@par Hardware and Software environment

  - This application runs on STM32MP257FAIx devices.

  - This application has been tested with PHYTEC phyFLEX-STM32MP257F FPSC Libra board and can be easily tailored to any other supported device
