...
typedef enum
{
  /* Define COM_VCP_CA35, COM_VCP_CM33, COM_CM0PLUS to match COM_USART[] table in stm32mp257f_phyflex.c
...
#define LED2_GPIO_PORT                   GPIOZ
#define LED2_PIN                         GPIO_PIN_7
#define LED2_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOZ_CLK_ENABLE()
#define LED2_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOZ_CLK_DISABLE()
#define LED2_GPIO_IS_CLK_ENABLED()       __HAL_RCC_GPIOZ_IS_CLK_ENABLED()
#define LED2_GPIO_RIF_RES_TYP_GPIO       RESMGR_RESOURCE_RIF_GPIOZ
#define LED2_GPIO_RIF_RES_NUM_GPIO       RESMGR_GPIO_PIN(7)

#define LED3_GPIO_PORT                   GPIOZ
#define LED3_PIN                         GPIO_PIN_8
#define LED3_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOZ_CLK_ENABLE()
#define LED3_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOZ_CLK_DISABLE()
#define LED3_GPIO_IS_CLK_ENABLED()       __HAL_RCC_GPIOZ_IS_CLK_ENABLED()
#define LED3_GPIO_RIF_RES_TYP_GPIO       RESMGR_RESOURCE_RIF_GPIOZ
#define LED3_GPIO_RIF_RES_NUM_GPIO       RESMGR_GPIO_PIN(8)
...
#define LED4_GPIO_RIF_RES_NUM_GPIO       RESMGR_GPIO_PIN(5)
...
/**
  ...
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
#define BUTTON_USER1_PIN                   GPIO_PIN_7
#define BUTTON_USER1_GPIO_PORT             GPIOI
#define BUTTON_USER1_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOI_CLK_ENABLE()
#define BUTTON_USER1_GPIO_CLK_DISABLE()    __HAL_RCC_GPIOI_CLK_DISABLE()
#define BUTTON_USER1_GPIO_IS_CLK_ENABLE()  __HAL_RCC_GPIOI_IS_CLK_ENABLED()
#define BUTTON_USER1_EXTI_IRQn             EXTI2_7_IRQn
#define BUTTON_USER1_EXTI_IRQ_HANDLER      EXTI2_7_IRQHandler
#define BUTTON_USER1_EXTI_LINE             EXTI2_LINE_7
#define BUTTON_USER1_RIF_RES_TYP_GPIO      RESMGR_RESOURCE_RIF_GPIOI
#define BUTTON_USER1_RIF_RES_NUM_GPIO      RESMGR_GPIO_PIN(7)
#endif /* CORE_CA35 || CORE_CM33 */
/**
  * @brief USER2 push-button
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
#define BUTTON_USER2_PIN                   GPIO_PIN_14
...
#define BUTTON_USER2_EXTI_IRQn             EXTI2_14_IRQn
#define BUTTON_USER2_EXTI_IRQ_HANDLER      EXTI2_14_IRQHandler
#define BUTTON_USER2_EXTI_LINE             EXTI2_LINE_14
#define BUTTON_USER2_RIF_RES_TYP_GPIO      RESMGR_RESOURCE_RIF_GPIOG
#define BUTTON_USER2_RIF_RES_NUM_GPIO      RESMGR_GPIO_PIN(14)
#endif /* CORE_CA35 || CORE_CM33 */
/**
  * @brief TAMPER push-button
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
#define BUTTON_TAMPER_PIN                   GPIO_PIN_3
#define BUTTON_TAMPER_GPIO_PORT             GPIOG
#define BUTTON_TAMPER_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOG_CLK_ENABLE()
#define BUTTON_TAMPER_GPIO_CLK_DISABLE()    __HAL_RCC_GPIOG_CLK_DISABLE()
#define BUTTON_TAMPER_GPIO_IS_CLK_ENABLE()  __HAL_RCC_GPIOG_IS_CLK_ENABLED()
#define BUTTON_TAMPER_EXTI_IRQn             EXTI2_3_IRQn
#define BUTTON_TAMPER_EXTI_IRQ_HANDLER      EXTI2_3_IRQHandler
#define BUTTON_TAMPER_EXTI_LINE             EXTI2_LINE_3
#define BUTTON_TAMPER_RIF_RES_TYP_GPIO      RESMGR_RESOURCE_RIF_GPIOG
#define BUTTON_TAMPER_RIF_RES_NUM_GPIO      RESMGR_GPIO_PIN(3)
#endif /* CORE_CA35 || CORE_CM33 */
/**
  * @}
  */
